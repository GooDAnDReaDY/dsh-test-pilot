...
![Визуальная проверка Test Pilot (обезличено)](media/visual-verification.png)

Этот обезличенный артефакт фиксирует проверенные карточку настроек Test Pilot и
чип статуса сессии в светлой и тёмной темах для финального кандидата 0.1.0.
В нём нет путей рабочих каталогов, идентификаторов сессий, credentials или
